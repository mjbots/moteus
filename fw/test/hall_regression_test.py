...
TESTS = [
    ...
    ('20250616-speed-cycle',       50,    0.10,    1.50, 1400.0,  280.0),
    ('20250616-back-and-forth',    50,    0.16,    1.50, 150.0,   70.0),
    ('20250616-bnforth-highaccel', 50,    0.09,    1.1,  190.0,   80.0),
    ('20250616-hboard-cycle',      50,    0.09,    1.50, 900.0,   130.0),
    ('20250616-hboard-manual',     50,    0.04,    1.1,  23.0,    20.0),
    ('20250615-new-slow',          50,    0.28,    1.50, 200.0,   80.0),

    ('20250616-speed-cycle',       124,   0.10,    1.50, 1400.0,  270.0),
    ('20250616-back-and-forth',    124,   0.16,    1.50, 190.0,   70.0),
    ('20250616-bnforth-highaccel', 124,   0.09,    1.1,  250.0,   80.0),
    ('20250616-hboard-cycle',      124,   0.09,    1.50, 1400.0,  160.0),
    ('20250616-hboard-manual',     124,   0.04,    1.1,  23.0,    20.0),
    ('20250615-new-slow',          124,   0.28,    1.50, 200.0,   80.0),

    ('20250616-speed-cycle',       248,   0.10,    1.50, 1400.0,  270.0),
    ('20250616-back-and-forth',    248,   0.16,    1.50, 190.0,   70.0),
    ('20250616-bnforth-highaccel', 248,   0.09,    1.1,  250.0,   80.0),
    ('20250616-hboard-cycle',      248,   0.09,    1.50, 2800.0,  180.0),
    ('20250616-hboard-manual',     248,   0.04,    1.1,  25.0,    20.0),
    ('20250615-new-slow',          248,   0.28,    1.50, 200.0,   80.0),

    ('20250616-speed-cycle',       496,   0.10,    1.50, 2800.0,  350.0),
    ('20250616-back-and-forth',    496,   0.16,    1.50, 190.0,   70.0),
    ('20250616-bnforth-highaccel', 496,   0.09,    1.1,  260.0,   80.0),
    ('20250616-hboard-cycle',      496,   0.09,    1.50, 2800.0,  180.0),
    ('20250616-hboard-manual',     496,   0.04,    1.1,  25.0,    20.0),
    ('20250615-new-slow',          496,   0.28,    1.50, 200.0,   80.0),

    ('20250616-speed-cycle',       992,   0.10,    1.50, 3500.0,  390.0),
    ('20250616-back-and-forth',    992,   0.16,    1.50, 200.0,   70.0),
    ('20250616-bnforth-highaccel', 992,   0.09,    1.1,  260.0,   80.0),
    ('20250616-hboard-cycle',      992,   0.09,    1.50, 2900.0,  180.0),
    ('20250616-hboard-manual',     992,   0.04,    1.1,  25.0,    20.0),
    ('20250615-new-slow',          992,   0.28,    1.50, 200.0,   80.0),
]
